<!-- <template>
  <div class="container mt-5">
    <div class="row">
      <div
        class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4 offset-0 offset-sm-1 offset-md-2 offset-lg-3 offset-xl-3 offset-xxl-4"
      >
...
const validateIsAustralian = () => {
  // Example validation: Check if checkbox is selected (for demonstration, not strictly necessary)
  if (formData.value.isAustralian === undefined) {
